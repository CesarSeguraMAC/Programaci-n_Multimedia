...
session_start();
    ...
    $nombre = 'Tela Reciclada Azul';
    $consi = 'Tela fabricada a partir de materiales reciclados con una textura suave y de alta calidad. Ideal para proyectos de moda sostenible, tapicería y decoración. ';
    $fecha = '2024-12-01';
    $priority = 'Media';
    $category = 'Tela';
