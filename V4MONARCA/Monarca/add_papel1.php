...
session_start();
    ...
    $nombre = 'Cartón Bigris';
    $consi = 'El cartón Bigris es un material de alta resistencia, ideal para proteger productos y utilizar en múltiples aplicaciones de embalaje. Su estructura rígida y duradera proporciona protección efectiva durante el transporte y almacenamiento, asegurando la integridad de los productos.';
    $fecha = '2024-12-03';
    $priority = 'Media';
    $category = 'Papel';
