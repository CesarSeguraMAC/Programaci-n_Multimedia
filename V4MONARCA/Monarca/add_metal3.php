...
session_start();
    ...
    $nombre = 'Aluminio' 
    $consi = 'El aluminio es un metal ligero, resistente y versátil, ideal para aplicaciones en construcción, transporte y manufactura. Su resistencia a la corrosión y su excelente relación resistencia-peso lo convierten en un material preferido en diversas industrias.';
    $fecha = '2024-12-03';
    $priority = 'Baja';
    $category = 'Metal';
