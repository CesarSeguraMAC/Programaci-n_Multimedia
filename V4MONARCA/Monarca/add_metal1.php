...
session_start();
    ...
    $nombre = ' Acero' 
    $consi = 'El acero es un material altamente resistente y duradero, compuesto principalmente de hierro y carbono. Su versatilidad y capacidad para soportar cargas y condiciones extremas lo convierten en una opción popular en construcción, fabricación y otras aplicaciones industriales.';
    $fecha = '2024-12-03';
    $priority = 'Baja';
    $category = 'Metal';
