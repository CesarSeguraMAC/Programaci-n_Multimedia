...
session_start();
    ...
    $nombre = 'Tela Reciclada Verde - Estilo Orgánico';
    $consi = 'Tela reciclada en tonos verdes para un estilo natural y orgánico. Perfecta para tapicería, ropa y accesorios eco-friendly.';
    $fecha = '2024-12-03';
    $priority = 'Media';
    $category = 'Tela';
